        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromMemberId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ToMemberId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_TrainingId_MemberId",
                table: "Attendances",
                columns: new[] { "TrainingId", "MemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Belts_BeltName",
                table: "Belts",
                column: "BeltName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberBelts_MemberId_CurrentBelt",
                table: "MemberBelts",
                column: "MemberId",
                unique: true,
                filter: "[IsCurrentBelt] = 1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notes_ToMemberId_Priority_CreatedAt",
                table: "Notes",
                columns: new[] { "ToMemberId", "Priority", "CreatedAt" });
